...
longer periods with no interactions.
...
One simple diagnostic is the Kolmogorov Smirnov test on whether the rescaled interevent times show departure from a standard exponential distribution.
...
A Hawkes process is not able to capture the nature of this data.


Comparing to the MMPP model.
```{r,eval=run_stan}
...
We can then plot the inferred latent state from this model.
